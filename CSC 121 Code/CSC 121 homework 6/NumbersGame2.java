...
public class NumbersGame2 {
	public static void main (String[] args) {
		...
		while (quit == 1) {
			...
			String playerNumber, playerNumber2, playerNumber3; 
			System.out.println("What is your first number? ");
			playerNumber=scan.next();
			playerArray[0] =  java.lang.Integer.parseInt(playerNumber);
			System.out.println("What is your second number? ");
			playerNumber2= scan.next();
			playerArray[1] = java.lang.Integer.parseInt(playerNumber2);
			System.out.println("What is your third number? ");
			playerNumber3=scan.next();
			playerArray[2] = java.lang.Integer.parseInt(playerNumber3);	
